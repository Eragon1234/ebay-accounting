...
export default async function Expenses(props: PageProps<"/[lang]/expenses">) {
    ...
    <>
      ...
      <Table
        columns={[
          ...
          {
            header: dict.expenses.amount,
            render: (a) => `${a.amount / euroToMicroEuro} €`,
          },
          {
            header: dict.expenses.taxType,
            render: (a) => formatType(a.taxType, a.vat),
          },
          {
            header: dict.expenses.date,
